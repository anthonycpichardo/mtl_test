...
# [MTL Live Session 07](https://github.com/markdownrefactor/teampsd/blob/master/mtl_facilitate_workgroup/mtl_live_guide/mtl_live_session07_see.Rmd "MTL Live Session 07")
...
<img src = "https://github.com/markdownrefactor/teampsd/blob/master/resources/icons/learning_objectives.png" height = "50" width = "50" style ="display: inline-block"/> **Learning Objectives:**
...
Time Stamp | Prioritize tailored team learning | Script
-- | -- | --
<img src = "https://github.com/markdownrefactor/teampsd/blob/master/resources/icons/timestamp.png" height = "30" width = "30" style ="display: inline-block"/> 00:20-00:25 | **Run** a simulation and save results | **Ask the team lead to narrate this process.**
...
Time Stamp | Prioritize tailored team learning | Script
-- | -- | --
<img src = "https://github.com/markdownrefactor/teampsd/blob/master/resources/icons/timestamp.png" height = "30" width = "30" style ="display: inline-block"/> 00:50-00:60 | **Success** - A successful Done/Do Review is short, specific, simple and shown.
...
||Note: If team has prioritized data on "New Patient Start Rate," then the start rate shown in the base case will match the estimate calculated from their patients' data, but the RVI used by the team will not.  If the RVI used by the team in the simulation is more frequent than the estimate, then this implies that the virtual team is either more efficient, has more capacity, fewer no-shows, or shorter engagement durations (or some combination) than the real-world team.  If the RVI used by the virtual team is slower than the real team, then the opposite is true -- that the real-world team is more efficient, has more capacity, fewer no-shows, or shorter engagement druations (or some combination) than we can see from their data.|
|| Decisions: |
